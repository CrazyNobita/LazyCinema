...
# ============================
SESSION = environ.get('SESSION', 'silenthours')   # Session name for the bot
API_ID = int(environ.get('API_ID', '25616977')) # API ID from my.telegram.org
API_HASH = environ.get('API_HASH', '6b3ab4e771f4c721ed2cfe467182b12a')  # API Hash from my.telegram.org
...
PICS = (environ.get('PICS', 'https://files.catbox.moe/bu1ea3.jpg')).split()  # Sample pic
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002121319531').split()]  # Channel id for auto indexing (make sure bot is admin)
...
# FORCE_SUB 
auth_req_channels = environ.get("AUTH_REQ_CHANNELS", "-1002071992507")# requst to join Channel for force sub (make sure bot is admin) only for bot ADMINS  
auth_channels     = environ.get("AUTH_CHANNELS", "-1002071992507")# Channels for force sub (make sure bot is admin)

# ============================
# Payment Configuration
# ============================
QR_CODE = environ.get('QR_CODE', 'https://files.catbox.moe/9n0tdb.jpg')    # QR code image for payments
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', 'suvambhaskar2004-1@okicici')    # Owner UPI ID for payments
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://silenthours1:SxoIMPG8DPwREdEC@silenthours1.jva7onz.mongodb.net/?retryWrites=true&w=majority&appName=silenthours1")  # MongoDB URI for the database
DATABASE_NAME = environ.get('DATABASE_NAME', "silenthours1") # Database name (default: cluster)
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'silenthourscollection') # Collection name (default: dreamcinezone_files)

# If MULTIPLE_DB Is True Then Fill DATABASE_URI2 Value Else You Will Get Error.
MULTIPLE_DB = is_enabled(os.environ.get('MULTIPLE_DB', "True"), False) # Type True For Turn On MULTIPLE DB FUNTION 
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://silenthours2:XuFlUZcvacy9xMVe@silenthours2.g7ez7y2.mongodb.net/?retryWrites=true&w=majority&appName=silenthours2")  # MongoDB URI for the second database (if MULTIPLE_DB is True)
# ============================
# Movie Notification & Update Settings
# ============================
MOVIE_UPDATE_NOTIFICATION = bool(environ.get('MOVIE_UPDATE_NOTIFICATION', True))  # Notification On (True) / Off (False)
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1001852506342'))  # Notification of sent to your channel
...
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002132361598')) #Verification Channel Id 
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002579641990')) #If Anyone Set Your Bot In Any Group And Set Shortner In That Group Then In This Channel The All Details Come
...
SHORTENER_API = environ.get("SHORTENER_API", "a2714d0b98a85e6b10044aad647f5fe45a53d4be") # Shortener API key
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", "linkshortify.com") # Shortener website

SHORTENER_API2 = environ.get("SHORTENER_API2", "74a0ee291f954258bbcc701b0c29779819edd881")  # Shortener API key for second website
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", "adrinolink.in") # Shortener website for second website

SHORTENER_API3 = environ.get("SHORTENER_API3", "a2714d0b98a85e6b10044aad647f5fe45a53d4be")  
SHORTENER_WEBSITE3 = environ.get("SHORTENER_WEBSITE3", "linkshortify.com") # Shortener website for third website

TWO_VERIFY_GAP = int(environ.get('TWO_VERIFY_GAP', "87000")) # Time gap for two-step verification in seconds (default: 20 minutes)
THREE_VERIFY_GAP = int(environ.get('THREE_VERIFY_GAP', "900000"))    

# ============================
# Channel & Group Links Configuration
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/movie_search_group_bollywood') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/silent_amv') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/silenthoursbackup') # Update channel link for the bot
