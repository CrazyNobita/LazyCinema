...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "SxoIMPG8DPwREdECmongodb+srv://silenthours1:SxoIMPG8DPwREdEC@silenthours1.jva7onz.mongodb.net/?retryWrites=true&w=majority&appName=silenthours1")  # MongoDB URI for the database
...
DATABASE_URI2 = environ.get('DATABASE_URI2', "XuFlUZcvacy9xMVemongodb+srv://silenthours2:XuFlUZcvacy9xMVe@silenthours2.g7ez7y2.mongodb.net/?retryWrites=true&w=majority&appName=silenthours2")  # MongoDB URI for the second database (if MULTIPLE_DB is True)
# ============================
...
THREE_VERIFY_GAP = int(environ.get('THREE_VERIFY_GAP', "90000"))    
