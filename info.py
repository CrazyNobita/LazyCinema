...
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1003876731385'))  # Premium logs channel id
...
# FORCE_SUB 
auth_req_channels = environ.get("AUTH_REQ_CHANNELS", "-1001533156579")# requst to join Channel for force sub (make sure bot is admin) only for bot ADMINS  
auth_channels     = environ.get("AUTH_CHANNELS", "-1002750931182")# Channels for force sub (make sure bot is admin)

# ============================
# Payment Configuration
# ============================
QR_CODE = environ.get('QR_CODE', 'https://freepichost.tech/i/6VV6TpgFiRjgXEJ5SRmges.png')    # QR code image for payments
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', 'mamtadhakad@naviaxis')    # Owner UPI ID for payments
...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1001533156579'))  # Notification of sent to your channel
...
# ============================
IS_VERIFY = is_enabled('IS_VERIFY', False)  # Verification On (False) / Off (False)
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002116984433')) #Verification Channel Id 
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002116984433')) #If Anyone Set Your Bot In Any Group And Set Shortner In That Group Then In This Channel The All Details Come
...
SHORTENER_API = environ.get("SHORTENER_API", "28a3c55db76ca779c036703aa29813c4cd21dd9b") # Shortener API key
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", "arolinks.com") # Shortener website

SHORTENER_API2 = environ.get("SHORTENER_API2", "28a3c55db76ca779c036703aa29813c4cd21dd9b")  # Shortener API key for second website
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", "arolinks.com") # Shortener website for second website

SHORTENER_API3 = environ.get("SHORTENER_API3", "28a3c55db76ca779c036703aa29813c4cd21dd9b")  
...
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/super4crazy78') # Update channel link for the bot
